...
namespace ControlBoardTest
{
    class Test_Equip
    {
         ...
         */
        public Test_Equip(string name, string ID, string comm, string address, int baud, StopBits stopbits)
        {
            ...
            {
                this.comm = comm;
                this.Device = new SerialPort(this.address, baud, Parity.None, 8, stopbits);
